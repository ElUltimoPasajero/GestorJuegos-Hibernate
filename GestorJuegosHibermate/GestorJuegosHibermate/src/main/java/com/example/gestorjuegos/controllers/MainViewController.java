...
public class MainViewController implements Initializable
{
    ...
    @javafx.fxml.FXML
    public void salir(ActionEvent actionEvent) { //Configuracion boton salir
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Session.setCurrentUser((new UserDAO()).get(Session.getCurrentUser().getId()));//Vamos  recargar el usuario para que regarge la sposibles modificaciones de la tabla
